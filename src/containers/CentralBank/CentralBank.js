  ...
  const wizardItems = [
    {
      ...
      command: () => navigate('/central-bank'),
    },
    {
      label: 'CBDC Manager',
      icon: 'pi pi-fw pi-edit',
      command: () => navigate('/central-bank/cbdc-manager'),
    },
    {
      label: 'Member  controls',
      icon: 'pi pi-fw pi-edit',
      command: () => navigate('/central-bank/member-controls'),
    },
    {
      label: 'Incoming Requests',
      icon: 'pi pi-fw pi-file',
      command: () => navigate('/home/incoming-requests'),
    },
    {
      label: 'treasury dashboard',
      icon: 'pi pi-fw pi-cog',
      command: () => navigate('/home/treasury-dashboard'),
    },
    {
      label: 'corda transaction dashboard',
      icon: 'pi pi-fw pi-cog',
      command: () => navigate('/home/corda-dashboard'),
    },
    {
      label: 'reference modals',
      icon: 'pi pi-fw pi-cog',
      command: () => navigate('/home/reference-modals'),
    },
    {
      label: 'visibility & reissuance',
      icon: 'pi pi-fw pi-cog',
      command: () => navigate('/home/visibility-reissuance'),
    },
  ];
